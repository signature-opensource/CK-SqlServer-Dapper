...
public class ProcedureTests : TestBase
{
    ...
    public void TestProcWithOutParameter()
    {
        ...
        controller.Execute( "#TestProcWithOutParameter", args, commandType: CommandType.StoredProcedure );
    ...
    public void TestProcWithOutAndReturnParameter()
    {
        ...
        controller.Execute( "#TestProcWithOutAndReturnParameter", args, commandType: CommandType.StoredProcedure );
        Assert.Equal( 7, args.Get<int>( "ID" ) );
    ...
    public void TestIssue17648290()
    {
        ...
        @"CREATE PROCEDURE #up_MessageProcessed_get
            ...
            END" );
        var result = controller.Query( sql: "#up_MessageProcessed_get", param: p, commandType: CommandType.StoredProcedure );
    ...
    public void SO24605346_ProcsAndStrings()
    {
        ...
        var result = controller.Query<PracticeRebateOrders>( "#GetPracticeRebateOrderByInvoiceNumber", new
        {
    ...
    public void Issue327_ReadEmptyProcedureResults()
    {
        ...
        var query = controller.QueryMultiple( "#TestEmptyResults", commandType: CommandType.StoredProcedure );
    ...
    public void TestProcSupport()
    {
        ...
        Assert.Equal( 1111, controller.Query<int>( "#TestProc", p, commandType: CommandType.StoredProcedure ).First() );
    ...
    {
        var results = controller.Query<string>( "select * from (select 'a' str union select 'b' union select 'c') X where str in @strings",
            new
            {
                strings = new[] {
    ...
    public void TestDateTime2PrecisionPreservedInDynamicParameters()
    {
        ...
        DateTime fromSelect = controller.Query<DateTime>( tempSPName, p, commandType: CommandType.StoredProcedure ).First();
